...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-motorcycle me-2"></i>MotorHub</a>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link act-cust" href="/Vehicle/bike"><i class="fa-solid fa-motorcycle me-1"></i> Buy a Bike</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-3">
                <div class="filter-panel">
                    ...
                    <form action="/Vehicle/filterpricebike" method="POST">
                        ...
                        <label for="customRange2" class="form-label text-muted" style="font-size: 0.85rem;">Price Range Threshold</label>
            ...
            <div class="col-12 col-lg-9">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h3 class="fw-bold mb-0">Available Bikes</h3>
                    <span class="badge bg-secondary px-3 py-2 fs-6">
                        <%= (bikeList != null) ? bikeList.size() : 0 %> Vehicles
                    </span>
                </div>
                            ...
                            <div class="row g-0">
                                <div class="col-12 col-md-5">
                                    <div class="veh-img-container">
                                        <img class="veh-img" src="<%= bike.getImage() %>" alt="<%= bike.getModel() %>">
                                        <div class="price-badge">₹ <%= bike.getPrice() %></div>
                                    </div>
                                </div>
                                    ...
                                    <div class="p-3 p-md-4 d-flex flex-column h-100 justify-content-between">
                                        <div>
                                            <div class="d-flex align-items-center justify-content-between">
                                                <h4 class="fw-bold mb-1"><%= bike.getModel() %></h4>
                                                <span class="badge bg-dark border border-secondary">ID: #<%= bike.getV_id() %></span>
                                            </div>
                                            <p class="text-muted small mb-2"><i class="fa-solid fa-location-dot me-1 text-info"></i> <%= bike.getArea() %>, <%= bike.getCity() %>, <%= bike.getState() %> - <%= bike.getZip() %></p>
                                            
                                            <!-- Spec Badges Grid -->
                                            <div class="spec-grid">
                                                <div class="spec-item">
                                                    <span class="spec-label">Type</span>
                                                    <span class="spec-value"><%= bike.getType() %></span>
                                                </div>
                                                <div class="spec-item">
                                                    <span class="spec-label">Color</span>
                                                    <span class="spec-value"><%= bike.getColor() %></span>
                                                </div>
                                                <div class="spec-item">
                                                    <span class="spec-label">Fuel</span>
                                                    <span class="spec-value"><%= bike.getFuel_type() %></span>
                                                </div>
                                                <div class="spec-item">
                                                    <span class="spec-label">Gear</span>
                                                    <span class="spec-value"><%= bike.getGear() %></span>
                                                </div>
                                                <div class="spec-item">
                                                    <span class="spec-label">Reg. Date</span>
                                                    <span class="spec-value"><%= bike.getReg_date() %></span>
                                                </div>
                                                <div class="spec-item">
                                                    <span class="spec-label">Owner ID</span>
                                                    <span class="spec-value">#<%= bike.getOwner_id() %></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <form action="/Vehicle/book" method="POST" class="mt-2">
                                            ...
                                            <button type="submit" class="btn-book" name="v_id" value="<%= bike.getV_id() %>">
                ...
                <% } else { %>
                    <div class="text-center py-5 rounded-4" style="background: var(--card-bg); border: 1px solid var(--border-color);">
                        <i class="fa-solid fa-motorcycle text-muted mb-3" style="font-size: 3rem;"></i>
                        <h5 class="text-muted">No bikes match your criteria.</h5>
                    </div>
                <% } %>
            </div>
    ...
    <footer>
        <div class="container">
            <h6 class="footer-title">Developed by Guru Swami</h6>
